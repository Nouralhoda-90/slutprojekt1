...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="woocommerce-login-button">
		<p><?php esc_html_e('Log in to use your member offers.', 'woocommerce'); ?></p>

		<a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>" class="button"><?php esc_html_e('LOG IN', 'woocommerce'); ?></a>
	</div>
